 ...
 <title> Created successfully </title>
   ...
   <meta http-equiv="Content-Language" content="ru" />
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
            ...
            <meta name="keywords" content="new room">
            <meta name="description" content="New room created successfully">
    ...
    <div class="wrapper">
        ...
        <div class="message_newroom_ok">
            <img src="../public/images/newroom/ico-new-room-key.png" width="32" class="message_newroom__language-leftimg">   
                <b> New Room created successfuly </b> <br>
                Remember your entry data: <br><br>
                Room № <b>  {{ $vroomnumber }}  </b> <br>
                Key: <b>  **____ </b>
        </div>
