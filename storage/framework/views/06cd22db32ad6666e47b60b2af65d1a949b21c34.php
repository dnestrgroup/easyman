 ...
 <title> Easyman eternal messenger for every day use </title>
   ...
   <meta http-equiv="Content-Language" content="ru" />
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
            ...
            <meta name="description" content="Easyman web messenger, requires little traffic, corporate use without Internet connection, need only browser to use, does not require updates, works on different devices and operating systems PC laptop tablet or cell phone, no phone number no email verification">
...
<div id="about">
    <div class="wrapper">
        ...
        Corporate use <br><br>
            <div class="howto__description-steps">
                "Easyman" Messenger also can work without Internet connection in Local Area Network (LAN). It is convenient to use in a company where Internet access denied to ordinary employees. To get this messenger in open source for corporate purposes, please write to our mail.
            </div>
            <br><br>

        How long it will live <br><br>
            <div class="howto__description-steps">
                Often we can hear that government is going to close access to messengers with End-to-End encryption under the cover of the fight against terrorism and one day you can lose touch with your contacts. Our messenger has no encryption algorithm so there is no reason to close it.
            </div>
            <br><br>
        </div>
...
<?php /**PATH E:\OpenServer529\OSPanel\domains\localhost\resources\views/index.blade.php ENDPATH**/ ?>